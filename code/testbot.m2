-- This is the default testbot.m2 provided for this repository
...
-- the top directory of the project repository:
--  docker run -v "`pwd`":"/home/macaulay" ghcr.io/mahrud/macaulay2 --script tests/testbot.m2
--  docker run -v "`pwd`":"/home/macaulay" -it --entrypoint bash ghcr.io/mahrud/macaulay2:latest
...
path = join( { currentDirectory() | "code/" }, path )
...
elapsedTime check("DirectSummands", Verbose => true)
